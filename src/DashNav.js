      ...
      <AppBar position="static" color='transparent' className = {classes.appbar} >
        <Toolbar>
          ...
          <ListIcon/>
           ...
           <Button color="info" href = '/dash'  >Home</Button> 
          <Button color="info" href = '/fir' >FIR</Button>
          <Button color="info" href = '/analysis' >CRIME INTENSITY ANALYSIS</Button>
          <Button color="info" href = '/'  >SIGN OUT</Button> 
        </Toolbar>
      </AppBar>
    </Box>
    </div>
